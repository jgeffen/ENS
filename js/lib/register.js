...
function check_username() {
	...
	$.post("inc/ajax/check_username_ajax.php", {username: username, ajax: true}, function(data) {
...
function check_email() {
	...
	$.post('inc/ajax/register.ajax.php', {check : 'email', email: email}, function(result) {
