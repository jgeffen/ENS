...
function add_predefined() {
	...
	$("#add_predefined_select").css("display", "block");
...
$('#control_add_wrapper').delegate("#add_predefined_select", 'change',  function() {
    ...
    if( id !== '' ) {
        ...
        $.ajax({
            ...
            data: { mode: "get_predefined", id: id, color: next_color },
            headers: getCSRFHeader($("#ens_control_token").val()),
        ...
        .fail(function (jqXHR, textStatus, errorThrown){
            ...
            ensAlert("Invalid Data", "There was an error processing your request. Please try again.");
        });
    } // end if(id!='')
});
